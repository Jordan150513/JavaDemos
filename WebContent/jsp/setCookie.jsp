...
<div align="center" style="margin:10px">
	<fieldset>
		<legend>the valuable cookie</legend>
	...
	<fieldset>
		...
		<form action="setCookie.jsp" method="post">
			<table>
				...
				<tr>
					<td></td>
					<td><input value="submit" type="submit" class="button"></td>
					<td><input value="refresh" type="button" class="button" onclick="location='setCookie.jsp'"></td>
				</tr>
			</table>
		</form>
	</fieldset>
